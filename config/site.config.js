...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'triphan@ubytxh.vn',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/lukaskronus/OneDrive-Indexer',
    },
  ],
